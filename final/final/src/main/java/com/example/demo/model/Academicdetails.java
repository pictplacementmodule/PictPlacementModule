...
public class Academicdetails {
	...
	@Column(name="placed" , columnDefinition="Boolean default 'false'")
	Boolean placed;
	...
	/*
	 * @Autowired percentage obj; public float getTwelfth() { return
	 * obj.getTwelfth(); } public void setTwelfth(float twelfth) {
	 * obj.setTwelfth(twelfth);
	 * 
	 * } public float getDiploma() { return obj.getDiploma();
	 * 
	 * } public void setDiploma(float diploma) { obj.setDiploma(diploma);
	 * 
	 * }
	 */
}