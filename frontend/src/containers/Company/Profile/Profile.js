...
function Profile(props) {
  ...
  function validate() {
    ...
    errors.contactNo1 =
      !/^\d+$/.test(state.contactNo1) || state.contactNo1.length != 10
        ? "Invalid mobile number!"
        : "";
    errors.contactNo2 =
      !/^\d+$/.test(state.contactNo2) || state.contactNo2.length != 10
        ? "Invalid mobile number!"
        : "";
    errors.contactNo3 =
      state.contactNo3.length != 0 &&
      (!/^\d+$/.test(state.contactNo3) || state.contactNo3.length != 10)
        ? "Invalid mobile number!"
        : "";
    ...
    errors.numberOfStudents = !/^\d+$/.test(state.numberOfStudents)
      ? "Invalid!"
      : "";
    errors.criteria =
      state.criteria == "" || Number(state.criteria) > 10 ? "Invalid!" : "";
    setError({
      ...errors,
    });
          ...
          <form className={classes.container} noValidate autoComplete="off">
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} align="right" onClick={submitHandler}>
                <Button
                  style={{ display: filled ? "none" : "block" }}
