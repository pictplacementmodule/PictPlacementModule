          ...
          >
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  {" "}
                  {this.state.company.active_backlogs
                    ? "Allowed"
                    : "Not Allowed"}
                </td>
              </tr>
              <tr>
                ...
                <td>
                  {this.state.company.passive_backlogs
                    ? "Allowed"
                    : "Not Allowed"}
                </td>
              </tr>
              <tr>
                <th scope="row">Branches Preferred</th>
                <td>
                  {Array(this.state.branchesPreffered).length > 0
                    ? Array(this.state.branchesPreffered).join()
                    : "Null"}
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  {Array(this.state.company.skills).length > 0
                    ? Array(this.state.company.skills).join()
                    : "Null"}
                </td>
              </tr>
              <tr>
                ...
                <td>
                  {Array(this.state.company.locality).length > 0
                    ? Array(this.state.company.locality).join()
                    : "Null"}
                </td>
              </tr>
            </tbody>
